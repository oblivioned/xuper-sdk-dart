...
class XChainErrorEnum extends $pb.ProtobufEnum {
  ...
  static const XChainErrorEnum UNKNOW_ERROR =
      XChainErrorEnum._(1, 'UNKNOW_ERROR');
  static const XChainErrorEnum CONNECT_REFUSE =
      XChainErrorEnum._(2, 'CONNECT_REFUSE');
  static const XChainErrorEnum NOT_ENOUGH_UTXO_ERROR =
      XChainErrorEnum._(3, 'NOT_ENOUGH_UTXO_ERROR');
  static const XChainErrorEnum UTXOVM_ALREADY_UNCONFIRM_ERROR =
      XChainErrorEnum._(4, 'UTXOVM_ALREADY_UNCONFIRM_ERROR');
  static const XChainErrorEnum UTXOVM_NOT_FOUND_ERROR =
      XChainErrorEnum._(5, 'UTXOVM_NOT_FOUND_ERROR');
  static const XChainErrorEnum INPUT_OUTPUT_NOT_EQUAL_ERROR =
      XChainErrorEnum._(6, 'INPUT_OUTPUT_NOT_EQUAL_ERROR');
  static const XChainErrorEnum TX_NOT_FOUND_ERROR =
      XChainErrorEnum._(7, 'TX_NOT_FOUND_ERROR');
  static const XChainErrorEnum TX_SIGN_ERROR =
      XChainErrorEnum._(8, 'TX_SIGN_ERROR');
  static const XChainErrorEnum BLOCKCHAIN_NOTEXIST =
      XChainErrorEnum._(9, 'BLOCKCHAIN_NOTEXIST');
  static const XChainErrorEnum VALIDATE_ERROR =
      XChainErrorEnum._(10, 'VALIDATE_ERROR');
  static const XChainErrorEnum CANNOT_SYNC_BLOCK_ERROR =
      XChainErrorEnum._(11, 'CANNOT_SYNC_BLOCK_ERROR');
  static const XChainErrorEnum CONFIRM_BLOCK_ERROR =
      XChainErrorEnum._(12, 'CONFIRM_BLOCK_ERROR');
  static const XChainErrorEnum UTXOVM_PLAY_ERROR =
      XChainErrorEnum._(13, 'UTXOVM_PLAY_ERROR');
  static const XChainErrorEnum WALK_ERROR = XChainErrorEnum._(14, 'WALK_ERROR');
  static const XChainErrorEnum NOT_READY_ERROR =
      XChainErrorEnum._(15, 'NOT_READY_ERROR');
  static const XChainErrorEnum BLOCK_EXIST_ERROR =
      XChainErrorEnum._(16, 'BLOCK_EXIST_ERROR');
  static const XChainErrorEnum ROOT_BLOCK_EXIST_ERROR =
      XChainErrorEnum._(17, 'ROOT_BLOCK_EXIST_ERROR');
  static const XChainErrorEnum TX_DUPLICATE_ERROR =
      XChainErrorEnum._(19, 'TX_DUPLICATE_ERROR');
  static const XChainErrorEnum SERVICE_REFUSED_ERROR =
      XChainErrorEnum._(20, 'SERVICE_REFUSED_ERROR');
  static const XChainErrorEnum TXDATA_SIGN_ERROR =
      XChainErrorEnum._(21, 'TXDATA_SIGN_ERROR');
  static const XChainErrorEnum TX_SLE_ERROR =
      XChainErrorEnum._(25, 'TX_SLE_ERROR');
  static const XChainErrorEnum TX_FEE_NOT_ENOUGH_ERROR =
      XChainErrorEnum._(26, 'TX_FEE_NOT_ENOUGH_ERROR');
  static const XChainErrorEnum UTXO_SIGN_ERROR =
      XChainErrorEnum._(28, 'UTXO_SIGN_ERROR');
  static const XChainErrorEnum DPOS_QUERY_ERROR =
      XChainErrorEnum._(31, 'DPOS_QUERY_ERROR');
  static const XChainErrorEnum RWSET_INVALID_ERROR =
      XChainErrorEnum._(33, 'RWSET_INVALID_ERROR');
  static const XChainErrorEnum RWACL_INVALID_ERROR =
      XChainErrorEnum._(34, 'RWACL_INVALID_ERROR');
  static const XChainErrorEnum GAS_NOT_ENOUGH_ERROR =
      XChainErrorEnum._(35, 'GAS_NOT_ENOUGH_ERROR');
  static const XChainErrorEnum TX_VERSION_INVALID_ERROR =
      XChainErrorEnum._(36, 'TX_VERSION_INVALID_ERROR');
  static const XChainErrorEnum COMPLIANCE_CHECK_NOT_APPROVED =
      XChainErrorEnum._(37, 'COMPLIANCE_CHECK_NOT_APPROVED');
  static const XChainErrorEnum ACCOUNT_CONTRACT_STATUS_ERROR =
      XChainErrorEnum._(38, 'ACCOUNT_CONTRACT_STATUS_ERROR');
  static const XChainErrorEnum TX_VERIFICATION_ERROR =
      XChainErrorEnum._(40, 'TX_VERIFICATION_ERROR');
  ...
  static final $core.Map<$core.int, XChainErrorEnum> _byValue =
...
class TransactionStatus extends $pb.ProtobufEnum {
  ...
  static const TransactionStatus FURCATION =
      TransactionStatus._(3, 'FURCATION');
  static const TransactionStatus UNCONFIRM =
      TransactionStatus._(4, 'UNCONFIRM');
...
class ViewOption extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, ViewOption> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class PermissionRule extends $pb.ProtobufEnum {
  ...
  static const PermissionRule SIGN_THRESHOLD =
      PermissionRule._(1, 'SIGN_THRESHOLD');
  ...
  static const PermissionRule COMMUNITY_VOTE =
      PermissionRule._(6, 'COMMUNITY_VOTE');
  ...
  static final $core.Map<$core.int, PermissionRule> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class Block_EBlockStatus extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, Block_EBlockStatus> _byValue =
      $pb.ProtobufEnum.initByValue(values);
