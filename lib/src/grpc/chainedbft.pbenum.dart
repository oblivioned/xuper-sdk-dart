...
class QCState extends $pb.ProtobufEnum {
  static const QCState NEW_VIEW = QCState._(0, 'NEW_VIEW');
  static const QCState PREPARE = QCState._(1, 'PREPARE');
  static const QCState PRE_COMMIT = QCState._(2, 'PRE_COMMIT');
