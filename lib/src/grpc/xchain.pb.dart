...
class Header extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Header',
    ...
    ..aOS(1, 'logid')
    ..aOS(2, 'fromNode')
    ..e<XChainErrorEnum>(3, 'error', $pb.PbFieldType.OE,
        defaultOrMaker: XChainErrorEnum.SUCCESS,
        valueOf: XChainErrorEnum.valueOf,
        enumValues: XChainErrorEnum.values)
...
class TxDataAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TxDataAccount',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'address')
    ..aOS(2, 'amount')
  ...
  factory TxDataAccount.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TxDataAccount.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TxDataAccount clone() => TxDataAccount()..mergeFromMessage(this);
  TxDataAccount copyWith(void Function(TxDataAccount) updates) =>
      super.copyWith((message) => updates(message as TxDataAccount));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TxDataAccount create() => TxDataAccount._();
  TxDataAccount createEmptyInstance() => create();
  static $pb.PbList<TxDataAccount> createRepeated() =>
      $pb.PbList<TxDataAccount>();
  @$core.pragma('dart2js:noInline')
  static TxDataAccount getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TxDataAccount>(create);
  ...
  @$pb.TagNumber(3)
  set frozenHeight($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
...
class TxData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TxData',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ...
    ..aOS(4, 'fromPubkey')
    ..aOS(5, 'fromScrkey')
    ..pc<TxDataAccount>(6, 'account', $pb.PbFieldType.PM,
        subBuilder: TxDataAccount.create)
    ..aOS(8, 'nonce')
    ..aInt64(9, 'timestamp')
  ...
  factory TxData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TxData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TxData clone() => TxData()..mergeFromMessage(this);
  TxData copyWith(void Function(TxData) updates) =>
      super.copyWith((message) => updates(message as TxData));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static TxData getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TxData>(create);
  ...
  @$pb.TagNumber(14)
  set userSign($core.List<$core.int> v) {
    $_setBytes(10, v);
  }
...
class TxStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TxStatus',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..a<$core.List<$core.int>>(3, 'txid', $pb.PbFieldType.OY)
    ..e<TransactionStatus>(4, 'status', $pb.PbFieldType.OE,
        defaultOrMaker: TransactionStatus.UNDEFINE,
  ...
  factory TxStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TxStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TxStatus clone() => TxStatus()..mergeFromMessage(this);
  TxStatus copyWith(void Function(TxStatus) updates) =>
      super.copyWith((message) => updates(message as TxStatus));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BatchTxs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BatchTxs',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..pc<TxStatus>(2, 'Txs', $pb.PbFieldType.PM,
        protoName: 'Txs', subBuilder: TxStatus.create)
    ..hasRequiredFields = false;

  BatchTxs._() : super();
  factory BatchTxs() => create();
  factory BatchTxs.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BatchTxs.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  BatchTxs clone() => BatchTxs()..mergeFromMessage(this);
  BatchTxs copyWith(void Function(BatchTxs) updates) =>
      super.copyWith((message) => updates(message as BatchTxs));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static BatchTxs getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchTxs>(create);
...
class Block extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Block',
    ...
    ..e<Block_EBlockStatus>(4, 'status', $pb.PbFieldType.OE,
        defaultOrMaker: Block_EBlockStatus.ERROR,
        valueOf: Block_EBlockStatus.valueOf,
        enumValues: Block_EBlockStatus.values)
  ...
  @$pb.TagNumber(4)
  set status(Block_EBlockStatus v) {
    setField(4, v);
  }
...
class BlockID extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BlockID',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'bcname')
...
class BlockHeight extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BlockHeight',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'bcname')
    ..aInt64(2, 'height')
...
class CommonReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CommonReply',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..hasRequiredFields = false;
  ...
  factory CommonReply.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CommonReply.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  CommonReply clone() => CommonReply()..mergeFromMessage(this);
  CommonReply copyWith(void Function(CommonReply) updates) =>
      super.copyWith((message) => updates(message as CommonReply));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CommonReply getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CommonReply>(create);
...
class CommonIn extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CommonIn',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..e<ViewOption>(2, 'viewOption', $pb.PbFieldType.OE,
        defaultOrMaker: ViewOption.NONE,
        valueOf: ViewOption.valueOf,
        enumValues: ViewOption.values)
    ..hasRequiredFields = false;

  CommonIn._() : super();
  factory CommonIn() => create();
  factory CommonIn.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CommonIn.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  CommonIn clone() => CommonIn()..mergeFromMessage(this);
  CommonIn copyWith(void Function(CommonIn) updates) =>
      super.copyWith((message) => updates(message as CommonIn));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CommonIn getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CommonIn>(create);
...
class TokenDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TokenDetail',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'bcname')
    ..aOS(2, 'balance')
    ..e<XChainErrorEnum>(3, 'error', $pb.PbFieldType.OE,
  ...
  factory TokenDetail.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TokenDetail.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TokenDetail clone() => TokenDetail()..mergeFromMessage(this);
  TokenDetail copyWith(void Function(TokenDetail) updates) =>
      super.copyWith((message) => updates(message as TokenDetail));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static TokenDetail getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TokenDetail>(create);
...
class AddressStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AddressStatus',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'address')
    ..pc<TokenDetail>(3, 'bcs', $pb.PbFieldType.PM,
        subBuilder: TokenDetail.create)
    ..hasRequiredFields = false;

  AddressStatus._() : super();
  factory AddressStatus() => create();
  factory AddressStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AddressStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AddressStatus clone() => AddressStatus()..mergeFromMessage(this);
  AddressStatus copyWith(void Function(AddressStatus) updates) =>
      super.copyWith((message) => updates(message as AddressStatus));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AddressStatus create() => AddressStatus._();
  AddressStatus createEmptyInstance() => create();
  static $pb.PbList<AddressStatus> createRepeated() =>
      $pb.PbList<AddressStatus>();
  @$core.pragma('dart2js:noInline')
  static AddressStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AddressStatus>(create);
...
class TokenFrozenDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TokenFrozenDetail',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'balance')
  ...
  factory TokenFrozenDetail.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TokenFrozenDetail.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TokenFrozenDetail clone() => TokenFrozenDetail()..mergeFromMessage(this);
  TokenFrozenDetail copyWith(void Function(TokenFrozenDetail) updates) =>
      super.copyWith((message) => updates(message as TokenFrozenDetail));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TokenFrozenDetail create() => TokenFrozenDetail._();
  TokenFrozenDetail createEmptyInstance() => create();
  static $pb.PbList<TokenFrozenDetail> createRepeated() =>
      $pb.PbList<TokenFrozenDetail>();
  @$core.pragma('dart2js:noInline')
  static TokenFrozenDetail getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TokenFrozenDetail>(create);
...
class TokenFrozenDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TokenFrozenDetails',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'bcname')
    ..pc<TokenFrozenDetail>(2, 'tfd', $pb.PbFieldType.PM,
        subBuilder: TokenFrozenDetail.create)
    ..e<XChainErrorEnum>(3, 'error', $pb.PbFieldType.OE,
        defaultOrMaker: XChainErrorEnum.SUCCESS,
        valueOf: XChainErrorEnum.valueOf,
        enumValues: XChainErrorEnum.values)
  ...
  factory TokenFrozenDetails.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TokenFrozenDetails.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TokenFrozenDetails clone() => TokenFrozenDetails()..mergeFromMessage(this);
  TokenFrozenDetails copyWith(void Function(TokenFrozenDetails) updates) =>
      super.copyWith((message) => updates(message as TokenFrozenDetails));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TokenFrozenDetails create() => TokenFrozenDetails._();
  TokenFrozenDetails createEmptyInstance() => create();
  static $pb.PbList<TokenFrozenDetails> createRepeated() =>
      $pb.PbList<TokenFrozenDetails>();
  @$core.pragma('dart2js:noInline')
  static TokenFrozenDetails getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TokenFrozenDetails>(create);
...
class AddressBalanceStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AddressBalanceStatus',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'address')
    ..pc<TokenFrozenDetails>(3, 'tfds', $pb.PbFieldType.PM,
        subBuilder: TokenFrozenDetails.create)
    ..hasRequiredFields = false;

  AddressBalanceStatus._() : super();
  factory AddressBalanceStatus() => create();
  factory AddressBalanceStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AddressBalanceStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AddressBalanceStatus clone() =>
      AddressBalanceStatus()..mergeFromMessage(this);
  AddressBalanceStatus copyWith(void Function(AddressBalanceStatus) updates) =>
      super.copyWith((message) => updates(message as AddressBalanceStatus));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AddressBalanceStatus create() => AddressBalanceStatus._();
  AddressBalanceStatus createEmptyInstance() => create();
  static $pb.PbList<AddressBalanceStatus> createRepeated() =>
      $pb.PbList<AddressBalanceStatus>();
  @$core.pragma('dart2js:noInline')
  static AddressBalanceStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AddressBalanceStatus>(create);
...
class TxInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TxInput',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(1)
  set refTxid($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
  ...
  @$pb.TagNumber(5)
  set fromAddr($core.List<$core.int> v) {
    $_setBytes(2, v);
  }
...
class TxOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TxOutput',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(2)
  set toAddr($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
...
class XuperSignature extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('XuperSignature',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory XuperSignature.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory XuperSignature.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  XuperSignature clone() => XuperSignature()..mergeFromMessage(this);
  XuperSignature copyWith(void Function(XuperSignature) updates) =>
      super.copyWith((message) => updates(message as XuperSignature));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static XuperSignature create() => XuperSignature._();
  XuperSignature createEmptyInstance() => create();
  static $pb.PbList<XuperSignature> createRepeated() =>
      $pb.PbList<XuperSignature>();
  @$core.pragma('dart2js:noInline')
  static XuperSignature getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<XuperSignature>(create);
...
class Transaction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Transaction',
    ...
    ..pc<TxOutput>(4, 'txOutputs', $pb.PbFieldType.PM,
    ...
    ..aOB(11, 'autogen')
    ..pc<TxInputExt>(23, 'txInputsExt', $pb.PbFieldType.PM,
        subBuilder: TxInputExt.create)
    ..pc<TxOutputExt>(24, 'txOutputsExt', $pb.PbFieldType.PM,
        subBuilder: TxOutputExt.create)
    ..pc<InvokeRequest>(25, 'contractRequests', $pb.PbFieldType.PM,
        subBuilder: InvokeRequest.create)
    ..aOS(26, 'initiator')
    ..pPS(27, 'authRequire')
    ..pc<SignatureInfo>(28, 'initiatorSigns', $pb.PbFieldType.PM,
        subBuilder: SignatureInfo.create)
    ..pc<SignatureInfo>(29, 'authRequireSigns', $pb.PbFieldType.PM,
        subBuilder: SignatureInfo.create)
  ...
  @$pb.TagNumber(30)
  set receivedTimestamp($fixnum.Int64 v) {
    $_setInt64(17, v);
  }
  ...
  @$pb.TagNumber(31)
  set xuperSign(XuperSignature v) {
    setField(31, v);
  }
...
class LedgerMeta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LedgerMeta',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory LedgerMeta.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LedgerMeta.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  LedgerMeta clone() => LedgerMeta()..mergeFromMessage(this);
  LedgerMeta copyWith(void Function(LedgerMeta) updates) =>
      super.copyWith((message) => updates(message as LedgerMeta));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static LedgerMeta getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LedgerMeta>(create);
  static LedgerMeta _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get rootBlockid => $_getN(0);
  @$pb.TagNumber(1)
  set rootBlockid($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set tipBlockid($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set trunkHeight($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
...
class UtxoMeta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UtxoMeta',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ...
    ..pc<InvokeRequest>(7, 'reservedContracts', $pb.PbFieldType.PM,
        subBuilder: InvokeRequest.create)
    ..aOM<InvokeRequest>(8, 'forbiddenContract',
        subBuilder: InvokeRequest.create)
    ..aInt64(9, 'newAccountResourceAmount')
    ..aInt64(10, 'irreversibleBlockHeight',
        protoName: 'irreversibleBlockHeight')
    ..aInt64(11, 'irreversibleSlideWindow',
        protoName: 'irreversibleSlideWindow')
    ..aOM<GasPrice>(12, 'gasPrice',
        protoName: 'gasPrice', subBuilder: GasPrice.create)
    ..aOM<InvokeRequest>(13, 'groupChainContract',
        subBuilder: InvokeRequest.create)
    ..hasRequiredFields = false;

  UtxoMeta._() : super();
  factory UtxoMeta() => create();
  factory UtxoMeta.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UtxoMeta.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UtxoMeta clone() => UtxoMeta()..mergeFromMessage(this);
  UtxoMeta copyWith(void Function(UtxoMeta) updates) =>
      super.copyWith((message) => updates(message as UtxoMeta));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static UtxoMeta getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UtxoMeta>(create);
  static UtxoMeta _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get latestBlockid => $_getN(0);
  @$pb.TagNumber(1)
  set latestBlockid($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
  ...
  @$pb.TagNumber(5)
  set unconfirmTxAmount($fixnum.Int64 v) {
    $_setInt64(4, v);
  }
  ...
  @$pb.TagNumber(6)
  set maxBlockSize($fixnum.Int64 v) {
    $_setInt64(5, v);
  }
  ...
  @$pb.TagNumber(8)
  set forbiddenContract(InvokeRequest v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(9)
  set newAccountResourceAmount($fixnum.Int64 v) {
    $_setInt64(8, v);
  }
  ...
  @$pb.TagNumber(10)
  set irreversibleBlockHeight($fixnum.Int64 v) {
    $_setInt64(9, v);
  }
  ...
  @$pb.TagNumber(11)
  set irreversibleSlideWindow($fixnum.Int64 v) {
    $_setInt64(10, v);
  }
  ...
  @$pb.TagNumber(13)
  set groupChainContract(InvokeRequest v) {
    setField(13, v);
  }
...
class GasPrice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GasPrice',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aInt64(1, 'cpuRate')
    ..aInt64(2, 'memRate')
    ..aInt64(3, 'diskRate')
  ...
  factory GasPrice.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GasPrice.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  GasPrice clone() => GasPrice()..mergeFromMessage(this);
  GasPrice copyWith(void Function(GasPrice) updates) =>
      super.copyWith((message) => updates(message as GasPrice));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static GasPrice getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GasPrice>(create);
  static GasPrice _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get cpuRate => $_getI64(0);
  @$pb.TagNumber(1)
  set cpuRate($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
...
class InternalBlock extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InternalBlock',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ...
    ..aInt64(9, 'height')
    ..aInt64(10, 'timestamp')
    ..pc<Transaction>(11, 'transactions', $pb.PbFieldType.PM,
    ...
    ..m<$core.String, $core.String>(18, 'failedTxs',
        entryClassName: 'InternalBlock.FailedTxsEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OS,
        packageName: const $pb.PackageName('pb'))
    ..a<$core.int>(19, 'targetBits', $pb.PbFieldType.O3,
        protoName: 'targetBits')
    ..aOM<$4.QuorumCert>(20, 'Justify',
        protoName: 'Justify', subBuilder: $4.QuorumCert.create)
    ..hasRequiredFields = false;

  InternalBlock._() : super();
  factory InternalBlock() => create();
  factory InternalBlock.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InternalBlock.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  InternalBlock clone() => InternalBlock()..mergeFromMessage(this);
  InternalBlock copyWith(void Function(InternalBlock) updates) =>
      super.copyWith((message) => updates(message as InternalBlock));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InternalBlock create() => InternalBlock._();
  InternalBlock createEmptyInstance() => create();
  static $pb.PbList<InternalBlock> createRepeated() =>
      $pb.PbList<InternalBlock>();
  @$core.pragma('dart2js:noInline')
  static InternalBlock getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InternalBlock>(create);
  ...
  @$pb.TagNumber(15)
  set nextHash($core.List<$core.int> v) {
    $_setBytes(14, v);
  }
  ...
  @$pb.TagNumber(17)
  set curBlockNum($fixnum.Int64 v) {
    $_setInt64(16, v);
  }
...
class BCStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BCStatus',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..aOM<LedgerMeta>(3, 'meta', subBuilder: LedgerMeta.create)
    ..aOM<InternalBlock>(4, 'block', subBuilder: InternalBlock.create)
    ..aOM<UtxoMeta>(5, 'utxoMeta',
        protoName: 'utxoMeta', subBuilder: UtxoMeta.create)
    ..pPS(6, 'branchBlockid', protoName: 'branchBlockid')
    ..hasRequiredFields = false;

  BCStatus._() : super();
  factory BCStatus() => create();
  factory BCStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BCStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  BCStatus clone() => BCStatus()..mergeFromMessage(this);
  BCStatus copyWith(void Function(BCStatus) updates) =>
      super.copyWith((message) => updates(message as BCStatus));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static BCStatus getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BCStatus>(create);
...
class BCTipStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BCTipStatus',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOB(2, 'isTrunkTip')
    ..hasRequiredFields = false;
  ...
  factory BCTipStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BCTipStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  BCTipStatus clone() => BCTipStatus()..mergeFromMessage(this);
  BCTipStatus copyWith(void Function(BCTipStatus) updates) =>
      super.copyWith((message) => updates(message as BCTipStatus));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static BCTipStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BCTipStatus>(create);
...
class BlockChains extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BlockChains',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..pPS(2, 'blockchains')
    ..hasRequiredFields = false;
  ...
  factory BlockChains.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BlockChains.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  BlockChains clone() => BlockChains()..mergeFromMessage(this);
  BlockChains copyWith(void Function(BlockChains) updates) =>
      super.copyWith((message) => updates(message as BlockChains));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static BlockChains getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BlockChains>(create);
...
class Speeds extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Speeds',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..m<$core.String, $core.double>(1, 'SumSpeeds',
        protoName: 'SumSpeeds',
        entryClassName: 'Speeds.SumSpeedsEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OD,
        packageName: const $pb.PackageName('pb'))
    ..m<$core.String, BCSpeeds>(2, 'BcSpeeds',
        protoName: 'BcSpeeds',
        entryClassName: 'Speeds.BcSpeedsEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: BCSpeeds.create,
        packageName: const $pb.PackageName('pb'))
    ..hasRequiredFields = false;

  Speeds._() : super();
  factory Speeds() => create();
  factory Speeds.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Speeds.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Speeds clone() => Speeds()..mergeFromMessage(this);
  Speeds copyWith(void Function(Speeds) updates) =>
      super.copyWith((message) => updates(message as Speeds));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Speeds getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Speeds>(create);
...
class BCSpeeds extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BCSpeeds',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..m<$core.String, $core.double>(1, 'BcSpeed',
        protoName: 'BcSpeed',
        entryClassName: 'BCSpeeds.BcSpeedEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OD,
        packageName: const $pb.PackageName('pb'))
    ..hasRequiredFields = false;
  ...
  factory BCSpeeds.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BCSpeeds.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  BCSpeeds clone() => BCSpeeds()..mergeFromMessage(this);
  BCSpeeds copyWith(void Function(BCSpeeds) updates) =>
      super.copyWith((message) => updates(message as BCSpeeds));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static BCSpeeds getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BCSpeeds>(create);
...
class SystemsStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SystemsStatus',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..pc<BCStatus>(2, 'bcsStatus', $pb.PbFieldType.PM,
        subBuilder: BCStatus.create)
  ...
  factory SystemsStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SystemsStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  SystemsStatus clone() => SystemsStatus()..mergeFromMessage(this);
  SystemsStatus copyWith(void Function(SystemsStatus) updates) =>
      super.copyWith((message) => updates(message as SystemsStatus));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SystemsStatus create() => SystemsStatus._();
  SystemsStatus createEmptyInstance() => create();
  static $pb.PbList<SystemsStatus> createRepeated() =>
      $pb.PbList<SystemsStatus>();
  @$core.pragma('dart2js:noInline')
  static SystemsStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SystemsStatus>(create);
...
class SystemsStatusReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SystemsStatusReply',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
  ...
  factory SystemsStatusReply.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SystemsStatusReply.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  SystemsStatusReply clone() => SystemsStatusReply()..mergeFromMessage(this);
  SystemsStatusReply copyWith(void Function(SystemsStatusReply) updates) =>
      super.copyWith((message) => updates(message as SystemsStatusReply));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SystemsStatusReply create() => SystemsStatusReply._();
  SystemsStatusReply createEmptyInstance() => create();
  static $pb.PbList<SystemsStatusReply> createRepeated() =>
      $pb.PbList<SystemsStatusReply>();
  @$core.pragma('dart2js:noInline')
  static SystemsStatusReply getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SystemsStatusReply>(create);
  ...
  @$pb.TagNumber(2)
  set systemsStatus(SystemsStatus v) {
    setField(2, v);
  }
...
class RawUrl extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RawUrl',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
  ...
  factory RawUrl.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RawUrl.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  RawUrl clone() => RawUrl()..mergeFromMessage(this);
  RawUrl copyWith(void Function(RawUrl) updates) =>
      super.copyWith((message) => updates(message as RawUrl));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static RawUrl getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RawUrl>(create);
...
class Utxo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Utxo',
    ...
    ..a<$core.List<$core.int>>(2, 'toAddr', $pb.PbFieldType.OY,
        protoName: 'toAddr')
    ..a<$core.List<$core.int>>(3, 'toPubkey', $pb.PbFieldType.OY,
        protoName: 'toPubkey')
    ..a<$core.List<$core.int>>(4, 'refTxid', $pb.PbFieldType.OY,
        protoName: 'refTxid')
  ...
  @$pb.TagNumber(3)
  set toPubkey($core.List<$core.int> v) {
    $_setBytes(2, v);
  }
...
class UtxoInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UtxoInput',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..aOS(3, 'address')
    ...
    ..a<$core.List<$core.int>>(7, 'userSign', $pb.PbFieldType.OY,
        protoName: 'userSign')
  ...
  factory UtxoInput.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UtxoInput.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UtxoInput clone() => UtxoInput()..mergeFromMessage(this);
  UtxoInput copyWith(void Function(UtxoInput) updates) =>
      super.copyWith((message) => updates(message as UtxoInput));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static UtxoInput getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UtxoInput>(create);
...
class UtxoOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UtxoOutput',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..pc<Utxo>(2, 'utxoList', $pb.PbFieldType.PM,
        protoName: 'utxoList', subBuilder: Utxo.create)
    ..aOS(3, 'totalSelected', protoName: 'totalSelected')
    ..hasRequiredFields = false;

  UtxoOutput._() : super();
  factory UtxoOutput() => create();
  factory UtxoOutput.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UtxoOutput.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UtxoOutput clone() => UtxoOutput()..mergeFromMessage(this);
  UtxoOutput copyWith(void Function(UtxoOutput) updates) =>
      super.copyWith((message) => updates(message as UtxoOutput));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static UtxoOutput getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UtxoOutput>(create);
  ...
  @$pb.TagNumber(3)
  set totalSelected($core.String v) {
    $_setString(2, v);
  }
...
class NativeCodeDesc extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NativeCodeDesc',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..aOS(2, 'version')
    ..a<$core.List<$core.int>>(3, 'digest', $pb.PbFieldType.OY)
    ..aOS(4, 'prevVersion', protoName: 'prevVersion')
    ..a<$core.int>(5, 'xuperApiVersion', $pb.PbFieldType.O3,
        protoName: 'xuperApiVersion')
    ..hasRequiredFields = false;

  NativeCodeDesc._() : super();
  factory NativeCodeDesc() => create();
  factory NativeCodeDesc.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NativeCodeDesc.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  NativeCodeDesc clone() => NativeCodeDesc()..mergeFromMessage(this);
  NativeCodeDesc copyWith(void Function(NativeCodeDesc) updates) =>
      super.copyWith((message) => updates(message as NativeCodeDesc));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NativeCodeDesc create() => NativeCodeDesc._();
  NativeCodeDesc createEmptyInstance() => create();
  static $pb.PbList<NativeCodeDesc> createRepeated() =>
      $pb.PbList<NativeCodeDesc>();
  @$core.pragma('dart2js:noInline')
  static NativeCodeDesc getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NativeCodeDesc>(create);
  ...
  @$pb.TagNumber(5)
  set xuperApiVersion($core.int v) {
    $_setSignedInt32(4, v);
  }
...
class WasmCodeDesc extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WasmCodeDesc',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'runtime')
    ..aOS(2, 'compiler')
    ..a<$core.List<$core.int>>(3, 'digest', $pb.PbFieldType.OY)
  ...
  factory WasmCodeDesc.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory WasmCodeDesc.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  WasmCodeDesc clone() => WasmCodeDesc()..mergeFromMessage(this);
  WasmCodeDesc copyWith(void Function(WasmCodeDesc) updates) =>
      super.copyWith((message) => updates(message as WasmCodeDesc));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static WasmCodeDesc create() => WasmCodeDesc._();
  WasmCodeDesc createEmptyInstance() => create();
  static $pb.PbList<WasmCodeDesc> createRepeated() =>
      $pb.PbList<WasmCodeDesc>();
  @$core.pragma('dart2js:noInline')
  static WasmCodeDesc getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<WasmCodeDesc>(create);
  ...
  @$pb.TagNumber(5)
  set contractType($core.String v) {
    $_setString(4, v);
  }
...
class DeployNativeCodeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeployNativeCodeRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
  ...
  factory DeployNativeCodeRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DeployNativeCodeRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DeployNativeCodeRequest clone() =>
      DeployNativeCodeRequest()..mergeFromMessage(this);
  DeployNativeCodeRequest copyWith(
          void Function(DeployNativeCodeRequest) updates) =>
      super.copyWith((message) => updates(message as DeployNativeCodeRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DeployNativeCodeRequest create() => DeployNativeCodeRequest._();
  DeployNativeCodeRequest createEmptyInstance() => create();
  static $pb.PbList<DeployNativeCodeRequest> createRepeated() =>
      $pb.PbList<DeployNativeCodeRequest>();
  @$core.pragma('dart2js:noInline')
  static DeployNativeCodeRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DeployNativeCodeRequest>(create);
...
class DeployNativeCodeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeployNativeCodeResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..hasRequiredFields = false;
  ...
  factory DeployNativeCodeResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DeployNativeCodeResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DeployNativeCodeResponse clone() =>
      DeployNativeCodeResponse()..mergeFromMessage(this);
  DeployNativeCodeResponse copyWith(
          void Function(DeployNativeCodeResponse) updates) =>
      super.copyWith((message) => updates(message as DeployNativeCodeResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DeployNativeCodeResponse create() => DeployNativeCodeResponse._();
  DeployNativeCodeResponse createEmptyInstance() => create();
  static $pb.PbList<DeployNativeCodeResponse> createRepeated() =>
      $pb.PbList<DeployNativeCodeResponse>();
  @$core.pragma('dart2js:noInline')
  static DeployNativeCodeResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DeployNativeCodeResponse>(create);
...
class NativeCodeStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NativeCodeStatus',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory NativeCodeStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NativeCodeStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  NativeCodeStatus clone() => NativeCodeStatus()..mergeFromMessage(this);
  NativeCodeStatus copyWith(void Function(NativeCodeStatus) updates) =>
      super.copyWith((message) => updates(message as NativeCodeStatus));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NativeCodeStatus create() => NativeCodeStatus._();
  NativeCodeStatus createEmptyInstance() => create();
  static $pb.PbList<NativeCodeStatus> createRepeated() =>
      $pb.PbList<NativeCodeStatus>();
  @$core.pragma('dart2js:noInline')
  static NativeCodeStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NativeCodeStatus>(create);
...
class NativeCodeStatusRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NativeCodeStatusRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..hasRequiredFields = false;
  ...
  factory NativeCodeStatusRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NativeCodeStatusRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  NativeCodeStatusRequest clone() =>
      NativeCodeStatusRequest()..mergeFromMessage(this);
  NativeCodeStatusRequest copyWith(
          void Function(NativeCodeStatusRequest) updates) =>
      super.copyWith((message) => updates(message as NativeCodeStatusRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NativeCodeStatusRequest create() => NativeCodeStatusRequest._();
  NativeCodeStatusRequest createEmptyInstance() => create();
  static $pb.PbList<NativeCodeStatusRequest> createRepeated() =>
      $pb.PbList<NativeCodeStatusRequest>();
  @$core.pragma('dart2js:noInline')
  static NativeCodeStatusRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NativeCodeStatusRequest>(create);
...
class NativeCodeStatusResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NativeCodeStatusResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..pc<NativeCodeStatus>(2, 'status', $pb.PbFieldType.PM,
        subBuilder: NativeCodeStatus.create)
    ..hasRequiredFields = false;

  NativeCodeStatusResponse._() : super();
  factory NativeCodeStatusResponse() => create();
  factory NativeCodeStatusResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NativeCodeStatusResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  NativeCodeStatusResponse clone() =>
      NativeCodeStatusResponse()..mergeFromMessage(this);
  NativeCodeStatusResponse copyWith(
          void Function(NativeCodeStatusResponse) updates) =>
      super.copyWith((message) => updates(message as NativeCodeStatusResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NativeCodeStatusResponse create() => NativeCodeStatusResponse._();
  NativeCodeStatusResponse createEmptyInstance() => create();
  static $pb.PbList<NativeCodeStatusResponse> createRepeated() =>
      $pb.PbList<NativeCodeStatusResponse>();
  @$core.pragma('dart2js:noInline')
  static NativeCodeStatusResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NativeCodeStatusResponse>(create);
...
class DposCandidatesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposCandidatesRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..hasRequiredFields = false;
  ...
  factory DposCandidatesRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposCandidatesRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposCandidatesRequest clone() =>
      DposCandidatesRequest()..mergeFromMessage(this);
  DposCandidatesRequest copyWith(
          void Function(DposCandidatesRequest) updates) =>
      super.copyWith((message) => updates(message as DposCandidatesRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposCandidatesRequest create() => DposCandidatesRequest._();
  DposCandidatesRequest createEmptyInstance() => create();
  static $pb.PbList<DposCandidatesRequest> createRepeated() =>
      $pb.PbList<DposCandidatesRequest>();
  @$core.pragma('dart2js:noInline')
  static DposCandidatesRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposCandidatesRequest>(create);
...
class DposCandidatesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposCandidatesResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
  ...
  factory DposCandidatesResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposCandidatesResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposCandidatesResponse clone() =>
      DposCandidatesResponse()..mergeFromMessage(this);
  DposCandidatesResponse copyWith(
          void Function(DposCandidatesResponse) updates) =>
      super.copyWith((message) => updates(message as DposCandidatesResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposCandidatesResponse create() => DposCandidatesResponse._();
  DposCandidatesResponse createEmptyInstance() => create();
  static $pb.PbList<DposCandidatesResponse> createRepeated() =>
      $pb.PbList<DposCandidatesResponse>();
  @$core.pragma('dart2js:noInline')
  static DposCandidatesResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposCandidatesResponse>(create);
...
class DposNominateRecordsRequest extends $pb.GeneratedMessage {
  ...
  factory DposNominateRecordsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposNominateRecordsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposNominateRecordsRequest clone() =>
      DposNominateRecordsRequest()..mergeFromMessage(this);
  DposNominateRecordsRequest copyWith(
          void Function(DposNominateRecordsRequest) updates) =>
      super.copyWith(
          (message) => updates(message as DposNominateRecordsRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static $pb.PbList<DposNominateRecordsRequest> createRepeated() =>
      $pb.PbList<DposNominateRecordsRequest>();
  @$core.pragma('dart2js:noInline')
  static DposNominateRecordsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposNominateRecordsRequest>(create);
...
class DposNominateInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposNominateInfo',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'candidate')
    ..aOS(2, 'txid')
    ..hasRequiredFields = false;
  ...
  factory DposNominateInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposNominateInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposNominateInfo clone() => DposNominateInfo()..mergeFromMessage(this);
  DposNominateInfo copyWith(void Function(DposNominateInfo) updates) =>
      super.copyWith((message) => updates(message as DposNominateInfo));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposNominateInfo create() => DposNominateInfo._();
  DposNominateInfo createEmptyInstance() => create();
  static $pb.PbList<DposNominateInfo> createRepeated() =>
      $pb.PbList<DposNominateInfo>();
  @$core.pragma('dart2js:noInline')
  static DposNominateInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposNominateInfo>(create);
...
class DposNominateRecordsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..pc<DposNominateInfo>(2, 'nominateRecords', $pb.PbFieldType.PM,
        protoName: 'nominateRecords', subBuilder: DposNominateInfo.create)
    ..hasRequiredFields = false;

  DposNominateRecordsResponse._() : super();
  factory DposNominateRecordsResponse() => create();
  factory DposNominateRecordsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposNominateRecordsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposNominateRecordsResponse clone() =>
      DposNominateRecordsResponse()..mergeFromMessage(this);
  DposNominateRecordsResponse copyWith(
          void Function(DposNominateRecordsResponse) updates) =>
      super.copyWith(
          (message) => updates(message as DposNominateRecordsResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposNominateRecordsResponse create() =>
      DposNominateRecordsResponse._();
  DposNominateRecordsResponse createEmptyInstance() => create();
  static $pb.PbList<DposNominateRecordsResponse> createRepeated() =>
      $pb.PbList<DposNominateRecordsResponse>();
  @$core.pragma('dart2js:noInline')
  static DposNominateRecordsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposNominateRecordsResponse>(create);
...
class DposNomineeRecordsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposNomineeRecordsRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..aOS(3, 'address')
  ...
  factory DposNomineeRecordsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposNomineeRecordsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposNomineeRecordsRequest clone() =>
      DposNomineeRecordsRequest()..mergeFromMessage(this);
  DposNomineeRecordsRequest copyWith(
          void Function(DposNomineeRecordsRequest) updates) =>
      super
          .copyWith((message) => updates(message as DposNomineeRecordsRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposNomineeRecordsRequest create() => DposNomineeRecordsRequest._();
  DposNomineeRecordsRequest createEmptyInstance() => create();
  static $pb.PbList<DposNomineeRecordsRequest> createRepeated() =>
      $pb.PbList<DposNomineeRecordsRequest>();
  @$core.pragma('dart2js:noInline')
  static DposNomineeRecordsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposNomineeRecordsRequest>(create);
...
class DposNomineeRecordsResponse extends $pb.GeneratedMessage {
  ...
  factory DposNomineeRecordsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposNomineeRecordsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposNomineeRecordsResponse clone() =>
      DposNomineeRecordsResponse()..mergeFromMessage(this);
  DposNomineeRecordsResponse copyWith(
          void Function(DposNomineeRecordsResponse) updates) =>
      super.copyWith(
          (message) => updates(message as DposNomineeRecordsResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static $pb.PbList<DposNomineeRecordsResponse> createRepeated() =>
      $pb.PbList<DposNomineeRecordsResponse>();
  @$core.pragma('dart2js:noInline')
  static DposNomineeRecordsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposNomineeRecordsResponse>(create);
...
class DposVoteRecordsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposVoteRecordsRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..aOS(3, 'address')
  ...
  factory DposVoteRecordsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposVoteRecordsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposVoteRecordsRequest clone() =>
      DposVoteRecordsRequest()..mergeFromMessage(this);
  DposVoteRecordsRequest copyWith(
          void Function(DposVoteRecordsRequest) updates) =>
      super.copyWith((message) => updates(message as DposVoteRecordsRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposVoteRecordsRequest create() => DposVoteRecordsRequest._();
  DposVoteRecordsRequest createEmptyInstance() => create();
  static $pb.PbList<DposVoteRecordsRequest> createRepeated() =>
      $pb.PbList<DposVoteRecordsRequest>();
  @$core.pragma('dart2js:noInline')
  static DposVoteRecordsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposVoteRecordsRequest>(create);
...
class voteRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('voteRecord',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'candidate')
    ..aOS(2, 'txid')
    ..hasRequiredFields = false;
  ...
  factory voteRecord.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory voteRecord.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  voteRecord clone() => voteRecord()..mergeFromMessage(this);
  voteRecord copyWith(void Function(voteRecord) updates) =>
      super.copyWith((message) => updates(message as voteRecord));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static voteRecord getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<voteRecord>(create);
...
class DposVoteRecordsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposVoteRecordsResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..pc<voteRecord>(2, 'voteTxidRecords', $pb.PbFieldType.PM,
        protoName: 'voteTxidRecords', subBuilder: voteRecord.create)
    ..hasRequiredFields = false;

  DposVoteRecordsResponse._() : super();
  factory DposVoteRecordsResponse() => create();
  factory DposVoteRecordsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposVoteRecordsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposVoteRecordsResponse clone() =>
      DposVoteRecordsResponse()..mergeFromMessage(this);
  DposVoteRecordsResponse copyWith(
          void Function(DposVoteRecordsResponse) updates) =>
      super.copyWith((message) => updates(message as DposVoteRecordsResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposVoteRecordsResponse create() => DposVoteRecordsResponse._();
  DposVoteRecordsResponse createEmptyInstance() => create();
  static $pb.PbList<DposVoteRecordsResponse> createRepeated() =>
      $pb.PbList<DposVoteRecordsResponse>();
  @$core.pragma('dart2js:noInline')
  static DposVoteRecordsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposVoteRecordsResponse>(create);
...
class DposVotedRecordsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposVotedRecordsRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..aOS(3, 'address')
  ...
  factory DposVotedRecordsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposVotedRecordsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposVotedRecordsRequest clone() =>
      DposVotedRecordsRequest()..mergeFromMessage(this);
  DposVotedRecordsRequest copyWith(
          void Function(DposVotedRecordsRequest) updates) =>
      super.copyWith((message) => updates(message as DposVotedRecordsRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposVotedRecordsRequest create() => DposVotedRecordsRequest._();
  DposVotedRecordsRequest createEmptyInstance() => create();
  static $pb.PbList<DposVotedRecordsRequest> createRepeated() =>
      $pb.PbList<DposVotedRecordsRequest>();
  @$core.pragma('dart2js:noInline')
  static DposVotedRecordsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposVotedRecordsRequest>(create);
...
class votedRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('votedRecord',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'voter')
    ..aOS(2, 'txid')
    ..hasRequiredFields = false;
  ...
  factory votedRecord.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory votedRecord.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  votedRecord clone() => votedRecord()..mergeFromMessage(this);
  votedRecord copyWith(void Function(votedRecord) updates) =>
      super.copyWith((message) => updates(message as votedRecord));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static votedRecord getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<votedRecord>(create);
...
class DposVotedRecordsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposVotedRecordsResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..pc<votedRecord>(2, 'votedTxidRecords', $pb.PbFieldType.PM,
        protoName: 'votedTxidRecords', subBuilder: votedRecord.create)
    ..hasRequiredFields = false;

  DposVotedRecordsResponse._() : super();
  factory DposVotedRecordsResponse() => create();
  factory DposVotedRecordsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposVotedRecordsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposVotedRecordsResponse clone() =>
      DposVotedRecordsResponse()..mergeFromMessage(this);
  DposVotedRecordsResponse copyWith(
          void Function(DposVotedRecordsResponse) updates) =>
      super.copyWith((message) => updates(message as DposVotedRecordsResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposVotedRecordsResponse create() => DposVotedRecordsResponse._();
  DposVotedRecordsResponse createEmptyInstance() => create();
  static $pb.PbList<DposVotedRecordsResponse> createRepeated() =>
      $pb.PbList<DposVotedRecordsResponse>();
  @$core.pragma('dart2js:noInline')
  static DposVotedRecordsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposVotedRecordsResponse>(create);
...
class DposCheckResultsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposCheckResultsRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..aInt64(3, 'term')
  ...
  factory DposCheckResultsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposCheckResultsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposCheckResultsRequest clone() =>
      DposCheckResultsRequest()..mergeFromMessage(this);
  DposCheckResultsRequest copyWith(
          void Function(DposCheckResultsRequest) updates) =>
      super.copyWith((message) => updates(message as DposCheckResultsRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposCheckResultsRequest create() => DposCheckResultsRequest._();
  DposCheckResultsRequest createEmptyInstance() => create();
  static $pb.PbList<DposCheckResultsRequest> createRepeated() =>
      $pb.PbList<DposCheckResultsRequest>();
  @$core.pragma('dart2js:noInline')
  static DposCheckResultsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposCheckResultsRequest>(create);
...
class DposCheckResultsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposCheckResultsResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aInt64(2, 'term')
  ...
  factory DposCheckResultsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposCheckResultsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposCheckResultsResponse clone() =>
      DposCheckResultsResponse()..mergeFromMessage(this);
  DposCheckResultsResponse copyWith(
          void Function(DposCheckResultsResponse) updates) =>
      super.copyWith((message) => updates(message as DposCheckResultsResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposCheckResultsResponse create() => DposCheckResultsResponse._();
  DposCheckResultsResponse createEmptyInstance() => create();
  static $pb.PbList<DposCheckResultsResponse> createRepeated() =>
      $pb.PbList<DposCheckResultsResponse>();
  @$core.pragma('dart2js:noInline')
  static DposCheckResultsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposCheckResultsResponse>(create);
...
class DposStatusRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposStatusRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..hasRequiredFields = false;
  ...
  factory DposStatusRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposStatusRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposStatusRequest clone() => DposStatusRequest()..mergeFromMessage(this);
  DposStatusRequest copyWith(void Function(DposStatusRequest) updates) =>
      super.copyWith((message) => updates(message as DposStatusRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposStatusRequest create() => DposStatusRequest._();
  DposStatusRequest createEmptyInstance() => create();
  static $pb.PbList<DposStatusRequest> createRepeated() =>
      $pb.PbList<DposStatusRequest>();
  @$core.pragma('dart2js:noInline')
  static DposStatusRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposStatusRequest>(create);
...
class DposStatusResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposStatusResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
  ...
  factory DposStatusResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposStatusResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposStatusResponse clone() => DposStatusResponse()..mergeFromMessage(this);
  DposStatusResponse copyWith(void Function(DposStatusResponse) updates) =>
      super.copyWith((message) => updates(message as DposStatusResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DposStatusResponse create() => DposStatusResponse._();
  DposStatusResponse createEmptyInstance() => create();
  static $pb.PbList<DposStatusResponse> createRepeated() =>
      $pb.PbList<DposStatusResponse>();
  @$core.pragma('dart2js:noInline')
  static DposStatusResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposStatusResponse>(create);
...
class DposStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DposStatus',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aInt64(1, 'term')
    ..aInt64(2, 'blockNum')
    ..aOS(3, 'proposer')
  ...
  factory DposStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DposStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  DposStatus clone() => DposStatus()..mergeFromMessage(this);
  DposStatus copyWith(void Function(DposStatus) updates) =>
      super.copyWith((message) => updates(message as DposStatus));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static DposStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DposStatus>(create);
  ...
  @$pb.TagNumber(4)
  set proposerNum($fixnum.Int64 v) {
    $_setInt64(3, v);
  }
...
class InvokeRPCRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InvokeRPCRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..pc<InvokeRequest>(3, 'requests', $pb.PbFieldType.PM,
        subBuilder: InvokeRequest.create)
    ..aOS(4, 'initiator')
    ..pPS(5, 'authRequire')
    ..hasRequiredFields = false;
  ...
  factory InvokeRPCRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InvokeRPCRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  InvokeRPCRequest clone() => InvokeRPCRequest()..mergeFromMessage(this);
  InvokeRPCRequest copyWith(void Function(InvokeRPCRequest) updates) =>
      super.copyWith((message) => updates(message as InvokeRPCRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InvokeRPCRequest create() => InvokeRPCRequest._();
  InvokeRPCRequest createEmptyInstance() => create();
  static $pb.PbList<InvokeRPCRequest> createRepeated() =>
      $pb.PbList<InvokeRPCRequest>();
  @$core.pragma('dart2js:noInline')
  static InvokeRPCRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InvokeRPCRequest>(create);
...
class InvokeRPCResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InvokeRPCResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
  ...
  factory InvokeRPCResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InvokeRPCResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  InvokeRPCResponse clone() => InvokeRPCResponse()..mergeFromMessage(this);
  InvokeRPCResponse copyWith(void Function(InvokeRPCResponse) updates) =>
      super.copyWith((message) => updates(message as InvokeRPCResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InvokeRPCResponse create() => InvokeRPCResponse._();
  InvokeRPCResponse createEmptyInstance() => create();
  static $pb.PbList<InvokeRPCResponse> createRepeated() =>
      $pb.PbList<InvokeRPCResponse>();
  @$core.pragma('dart2js:noInline')
  static InvokeRPCResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InvokeRPCResponse>(create);
...
class InvokeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InvokeRequest',
    ...
    ..aOS(2, 'contractName')
    ..aOS(3, 'methodName')
    ..m<$core.String, $core.List<$core.int>>(4, 'args',
        entryClassName: 'InvokeRequest.ArgsEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OY,
        packageName: const $pb.PackageName('pb'))
    ..pc<ResourceLimit>(5, 'resourceLimits', $pb.PbFieldType.PM,
  ...
  @$pb.TagNumber(2)
  set contractName($core.String v) {
    $_setString(1, v);
  }
...
class InvokeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InvokeResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..pc<TxInputExt>(1, 'inputs', $pb.PbFieldType.PM,
        subBuilder: TxInputExt.create)
    ..pc<TxOutputExt>(2, 'outputs', $pb.PbFieldType.PM,
        subBuilder: TxOutputExt.create)
    ..p<$core.List<$core.int>>(3, 'response', $pb.PbFieldType.PY)
    ..aInt64(4, 'gasUsed')
    ..pc<InvokeRequest>(5, 'requests', $pb.PbFieldType.PM,
        subBuilder: InvokeRequest.create)
    ..pc<ContractResponse>(6, 'responses', $pb.PbFieldType.PM,
        subBuilder: ContractResponse.create)
    ..pc<TxInput>(7, 'utxoInputs', $pb.PbFieldType.PM,
        protoName: 'utxoInputs', subBuilder: TxInput.create)
    ..pc<TxOutput>(8, 'utxoOutputs', $pb.PbFieldType.PM,
        protoName: 'utxoOutputs', subBuilder: TxOutput.create)
    ..hasRequiredFields = false;
...
class TxInputExt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TxInputExt',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'bucket')
  ...
  factory TxInputExt.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TxInputExt.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TxInputExt clone() => TxInputExt()..mergeFromMessage(this);
  TxInputExt copyWith(void Function(TxInputExt) updates) =>
      super.copyWith((message) => updates(message as TxInputExt));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static TxInputExt getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TxInputExt>(create);
...
class TxOutputExt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TxOutputExt',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'bucket')
    ..a<$core.List<$core.int>>(2, 'key', $pb.PbFieldType.OY)
  ...
  factory TxOutputExt.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TxOutputExt.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TxOutputExt clone() => TxOutputExt()..mergeFromMessage(this);
  TxOutputExt copyWith(void Function(TxOutputExt) updates) =>
      super.copyWith((message) => updates(message as TxOutputExt));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static TxOutputExt getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TxOutputExt>(create);
...
class SignatureInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SignatureInfo',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory SignatureInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SignatureInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  SignatureInfo clone() => SignatureInfo()..mergeFromMessage(this);
  SignatureInfo copyWith(void Function(SignatureInfo) updates) =>
      super.copyWith((message) => updates(message as SignatureInfo));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SignatureInfo create() => SignatureInfo._();
  SignatureInfo createEmptyInstance() => create();
  static $pb.PbList<SignatureInfo> createRepeated() =>
      $pb.PbList<SignatureInfo>();
  @$core.pragma('dart2js:noInline')
  static SignatureInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SignatureInfo>(create);
...
class PermissionModel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PermissionModel',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..e<PermissionRule>(1, 'rule', $pb.PbFieldType.OE,
        defaultOrMaker: PermissionRule.NULL,
        valueOf: PermissionRule.valueOf,
        enumValues: PermissionRule.values)
    ..a<$core.double>(2, 'acceptValue', $pb.PbFieldType.OD,
        protoName: 'acceptValue')
    ..hasRequiredFields = false;

  PermissionModel._() : super();
  factory PermissionModel() => create();
  factory PermissionModel.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PermissionModel.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  PermissionModel clone() => PermissionModel()..mergeFromMessage(this);
  PermissionModel copyWith(void Function(PermissionModel) updates) =>
      super.copyWith((message) => updates(message as PermissionModel));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PermissionModel create() => PermissionModel._();
  PermissionModel createEmptyInstance() => create();
  static $pb.PbList<PermissionModel> createRepeated() =>
      $pb.PbList<PermissionModel>();
  @$core.pragma('dart2js:noInline')
  static PermissionModel getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PermissionModel>(create);
  static PermissionModel _defaultInstance;

  @$pb.TagNumber(1)
  PermissionRule get rule => $_getN(0);
  @$pb.TagNumber(1)
  set rule(PermissionRule v) {
    setField(1, v);
  }
...
class AkSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AkSet',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..pPS(1, 'aks')
    ..hasRequiredFields = false;
  ...
  factory AkSet.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AkSet.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AkSet clone() => AkSet()..mergeFromMessage(this);
  AkSet copyWith(void Function(AkSet) updates) =>
      super.copyWith((message) => updates(message as AkSet));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static AkSet getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AkSet>(create);
...
class AkSets extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AkSets',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..m<$core.String, AkSet>(1, 'sets',
        entryClassName: 'AkSets.SetsEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: AkSet.create,
        packageName: const $pb.PackageName('pb'))
    ..aOS(2, 'expression')
    ..hasRequiredFields = false;
  ...
  factory AkSets.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AkSets.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AkSets clone() => AkSets()..mergeFromMessage(this);
  AkSets copyWith(void Function(AkSets) updates) =>
      super.copyWith((message) => updates(message as AkSets));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static AkSets getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AkSets>(create);
...
class Acl extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Acl',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<PermissionModel>(1, 'pm', subBuilder: PermissionModel.create)
    ..m<$core.String, $core.double>(2, 'aksWeight',
        protoName: 'aksWeight',
        entryClassName: 'Acl.AksWeightEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OD,
        packageName: const $pb.PackageName('pb'))
  ...
  Acl copyWith(void Function(Acl) updates) =>
      super.copyWith((message) => updates(message as Acl));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AclStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AclStatus',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
  ...
  factory AclStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AclStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AclStatus clone() => AclStatus()..mergeFromMessage(this);
  AclStatus copyWith(void Function(AclStatus) updates) =>
      super.copyWith((message) => updates(message as AclStatus));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static AclStatus getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AclStatus>(create);
...
class IdentityAuth extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IdentityAuth',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory IdentityAuth.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory IdentityAuth.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  IdentityAuth clone() => IdentityAuth()..mergeFromMessage(this);
  IdentityAuth copyWith(void Function(IdentityAuth) updates) =>
      super.copyWith((message) => updates(message as IdentityAuth));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static IdentityAuth create() => IdentityAuth._();
  IdentityAuth createEmptyInstance() => create();
  static $pb.PbList<IdentityAuth> createRepeated() =>
      $pb.PbList<IdentityAuth>();
  @$core.pragma('dart2js:noInline')
  static IdentityAuth getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<IdentityAuth>(create);
...
class IdentityAuths extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IdentityAuths',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..pc<IdentityAuth>(1, 'auth', $pb.PbFieldType.PM,
        subBuilder: IdentityAuth.create)
    ..hasRequiredFields = false;

  IdentityAuths._() : super();
  factory IdentityAuths() => create();
  factory IdentityAuths.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory IdentityAuths.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  IdentityAuths clone() => IdentityAuths()..mergeFromMessage(this);
  IdentityAuths copyWith(void Function(IdentityAuths) updates) =>
      super.copyWith((message) => updates(message as IdentityAuths));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static IdentityAuths create() => IdentityAuths._();
  IdentityAuths createEmptyInstance() => create();
  static $pb.PbList<IdentityAuths> createRepeated() =>
      $pb.PbList<IdentityAuths>();
  @$core.pragma('dart2js:noInline')
  static IdentityAuths getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<IdentityAuths>(create);
...
class ResourceLimit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResourceLimit',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..e<ResourceType>(1, 'type', $pb.PbFieldType.OE,
        defaultOrMaker: ResourceType.CPU,
...
class AK2AccountRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AK2AccountRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..aOS(3, 'address')
  ...
  factory AK2AccountRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AK2AccountRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AK2AccountRequest clone() => AK2AccountRequest()..mergeFromMessage(this);
  AK2AccountRequest copyWith(void Function(AK2AccountRequest) updates) =>
      super.copyWith((message) => updates(message as AK2AccountRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AK2AccountRequest create() => AK2AccountRequest._();
  AK2AccountRequest createEmptyInstance() => create();
  static $pb.PbList<AK2AccountRequest> createRepeated() =>
      $pb.PbList<AK2AccountRequest>();
  @$core.pragma('dart2js:noInline')
  static AK2AccountRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AK2AccountRequest>(create);
...
class AK2AccountResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AK2AccountResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..pPS(3, 'account')
  ...
  factory AK2AccountResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AK2AccountResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AK2AccountResponse clone() => AK2AccountResponse()..mergeFromMessage(this);
  AK2AccountResponse copyWith(void Function(AK2AccountResponse) updates) =>
      super.copyWith((message) => updates(message as AK2AccountResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AK2AccountResponse create() => AK2AccountResponse._();
  AK2AccountResponse createEmptyInstance() => create();
  static $pb.PbList<AK2AccountResponse> createRepeated() =>
      $pb.PbList<AK2AccountResponse>();
  @$core.pragma('dart2js:noInline')
  static AK2AccountResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AK2AccountResponse>(create);
...
class GetAccountContractsRequest extends $pb.GeneratedMessage {
  ...
  factory GetAccountContractsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetAccountContractsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  GetAccountContractsRequest clone() =>
      GetAccountContractsRequest()..mergeFromMessage(this);
  GetAccountContractsRequest copyWith(
          void Function(GetAccountContractsRequest) updates) =>
      super.copyWith(
          (message) => updates(message as GetAccountContractsRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static $pb.PbList<GetAccountContractsRequest> createRepeated() =>
      $pb.PbList<GetAccountContractsRequest>();
  @$core.pragma('dart2js:noInline')
  static GetAccountContractsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetAccountContractsRequest>(create);
...
class GetAccountContractsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..pc<ContractStatus>(2, 'contractsStatus', $pb.PbFieldType.PM,
        subBuilder: ContractStatus.create)
    ..hasRequiredFields = false;

  GetAccountContractsResponse._() : super();
  factory GetAccountContractsResponse() => create();
  factory GetAccountContractsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetAccountContractsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  GetAccountContractsResponse clone() =>
      GetAccountContractsResponse()..mergeFromMessage(this);
  GetAccountContractsResponse copyWith(
          void Function(GetAccountContractsResponse) updates) =>
      super.copyWith(
          (message) => updates(message as GetAccountContractsResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetAccountContractsResponse create() =>
      GetAccountContractsResponse._();
  GetAccountContractsResponse createEmptyInstance() => create();
  static $pb.PbList<GetAccountContractsResponse> createRepeated() =>
      $pb.PbList<GetAccountContractsResponse>();
  @$core.pragma('dart2js:noInline')
  static GetAccountContractsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetAccountContractsResponse>(create);
...
class ContractStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ContractStatus',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'contractName')
    ..aOS(2, 'txid')
...
class PreExecWithSelectUTXORequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<SignatureInfo>(6, 'signInfo',
        protoName: 'signInfo', subBuilder: SignatureInfo.create)
    ..aOB(7, 'needLock', protoName: 'needLock')
    ..hasRequiredFields = false;

  PreExecWithSelectUTXORequest._() : super();
  factory PreExecWithSelectUTXORequest() => create();
  factory PreExecWithSelectUTXORequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PreExecWithSelectUTXORequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  PreExecWithSelectUTXORequest clone() =>
      PreExecWithSelectUTXORequest()..mergeFromMessage(this);
  PreExecWithSelectUTXORequest copyWith(
          void Function(PreExecWithSelectUTXORequest) updates) =>
      super.copyWith(
          (message) => updates(message as PreExecWithSelectUTXORequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PreExecWithSelectUTXORequest create() =>
      PreExecWithSelectUTXORequest._();
  PreExecWithSelectUTXORequest createEmptyInstance() => create();
  static $pb.PbList<PreExecWithSelectUTXORequest> createRepeated() =>
      $pb.PbList<PreExecWithSelectUTXORequest>();
  @$core.pragma('dart2js:noInline')
  static PreExecWithSelectUTXORequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PreExecWithSelectUTXORequest>(create);
  ...
  @$pb.TagNumber(5)
  set request(InvokeRPCRequest v) {
    setField(5, v);
  }
...
class PreExecWithSelectUTXOResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(2, 'bcname')
    ..aOM<InvokeResponse>(3, 'response', subBuilder: InvokeResponse.create)
    ..aOM<UtxoOutput>(4, 'utxoOutput',
        protoName: 'utxoOutput', subBuilder: UtxoOutput.create)
    ..hasRequiredFields = false;

  PreExecWithSelectUTXOResponse._() : super();
  factory PreExecWithSelectUTXOResponse() => create();
  factory PreExecWithSelectUTXOResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PreExecWithSelectUTXOResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  PreExecWithSelectUTXOResponse clone() =>
      PreExecWithSelectUTXOResponse()..mergeFromMessage(this);
  PreExecWithSelectUTXOResponse copyWith(
          void Function(PreExecWithSelectUTXOResponse) updates) =>
      super.copyWith(
          (message) => updates(message as PreExecWithSelectUTXOResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PreExecWithSelectUTXOResponse create() =>
      PreExecWithSelectUTXOResponse._();
  PreExecWithSelectUTXOResponse createEmptyInstance() => create();
  static $pb.PbList<PreExecWithSelectUTXOResponse> createRepeated() =>
      $pb.PbList<PreExecWithSelectUTXOResponse>();
  @$core.pragma('dart2js:noInline')
  static PreExecWithSelectUTXOResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PreExecWithSelectUTXOResponse>(create);
...
class ContractResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ContractResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory ContractResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContractResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ContractResponse clone() => ContractResponse()..mergeFromMessage(this);
  ContractResponse copyWith(void Function(ContractResponse) updates) =>
      super.copyWith((message) => updates(message as ContractResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ContractResponse create() => ContractResponse._();
  ContractResponse createEmptyInstance() => create();
  static $pb.PbList<ContractResponse> createRepeated() =>
      $pb.PbList<ContractResponse>();
  @$core.pragma('dart2js:noInline')
  static ContractResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContractResponse>(create);
...
class ModifyBlock extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ModifyBlock',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'effectiveTxid')
    ..aOB(2, 'marked')
  ...
  factory ModifyBlock.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ModifyBlock.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ModifyBlock clone() => ModifyBlock()..mergeFromMessage(this);
  ModifyBlock copyWith(void Function(ModifyBlock) updates) =>
      super.copyWith((message) => updates(message as ModifyBlock));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ModifyBlock getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ModifyBlock>(create);
  static ModifyBlock _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get effectiveTxid => $_getSZ(0);
  @$pb.TagNumber(1)
  set effectiveTxid($core.String v) {
    $_setString(0, v);
  }
  ...
  @$pb.TagNumber(3)
  set effectiveHeight($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
...
class HDInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HDInfo',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory HDInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory HDInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  HDInfo clone() => HDInfo()..mergeFromMessage(this);
  HDInfo copyWith(void Function(HDInfo) updates) =>
      super.copyWith((message) => updates(message as HDInfo));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static HDInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HDInfo>(create);
  static HDInfo _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get hdPublicKey => $_getN(0);
  @$pb.TagNumber(1)
  set hdPublicKey($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set originalHash($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
...
class UtxoRecordDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UtxoRecordDetail',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..aOS(3, 'accountName', protoName: 'accountName')
    ..aOM<UtxoRecord>(4, 'openUtxoRecord',
        protoName: 'openUtxoRecord', subBuilder: UtxoRecord.create)
    ..aOM<UtxoRecord>(5, 'lockedUtxoRecord',
        protoName: 'lockedUtxoRecord', subBuilder: UtxoRecord.create)
    ..aOM<UtxoRecord>(6, 'frozenUtxoRecord',
        protoName: 'frozenUtxoRecord', subBuilder: UtxoRecord.create)
    ..aInt64(7, 'displayCount', protoName: 'displayCount')
    ..hasRequiredFields = false;

  UtxoRecordDetail._() : super();
  factory UtxoRecordDetail() => create();
  factory UtxoRecordDetail.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UtxoRecordDetail.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UtxoRecordDetail clone() => UtxoRecordDetail()..mergeFromMessage(this);
  UtxoRecordDetail copyWith(void Function(UtxoRecordDetail) updates) =>
      super.copyWith((message) => updates(message as UtxoRecordDetail));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UtxoRecordDetail create() => UtxoRecordDetail._();
  UtxoRecordDetail createEmptyInstance() => create();
  static $pb.PbList<UtxoRecordDetail> createRepeated() =>
      $pb.PbList<UtxoRecordDetail>();
  @$core.pragma('dart2js:noInline')
  static UtxoRecordDetail getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UtxoRecordDetail>(create);
  ...
  @$pb.TagNumber(4)
  set openUtxoRecord(UtxoRecord v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set lockedUtxoRecord(UtxoRecord v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(6)
  set frozenUtxoRecord(UtxoRecord v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(7)
  set displayCount($fixnum.Int64 v) {
    $_setInt64(6, v);
  }
...
class UtxoRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UtxoRecord',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory UtxoRecord.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UtxoRecord.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UtxoRecord clone() => UtxoRecord()..mergeFromMessage(this);
  UtxoRecord copyWith(void Function(UtxoRecord) updates) =>
      super.copyWith((message) => updates(message as UtxoRecord));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static UtxoRecord getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UtxoRecord>(create);
  static UtxoRecord _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get utxoCount => $_getSZ(0);
  @$pb.TagNumber(1)
  set utxoCount($core.String v) {
    $_setString(0, v);
  }
...
class UtxoKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UtxoKey',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory UtxoKey.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UtxoKey.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UtxoKey clone() => UtxoKey()..mergeFromMessage(this);
  UtxoKey copyWith(void Function(UtxoKey) updates) =>
      super.copyWith((message) => updates(message as UtxoKey));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static UtxoKey getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UtxoKey>(create);
  static UtxoKey _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get refTxid => $_getSZ(0);
  @$pb.TagNumber(1)
  set refTxid($core.String v) {
    $_setString(0, v);
  }
...
class ContractStatDataRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ContractStatDataRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..hasRequiredFields = false;
  ...
  factory ContractStatDataRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContractStatDataRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ContractStatDataRequest clone() =>
      ContractStatDataRequest()..mergeFromMessage(this);
  ContractStatDataRequest copyWith(
          void Function(ContractStatDataRequest) updates) =>
      super.copyWith((message) => updates(message as ContractStatDataRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ContractStatDataRequest create() => ContractStatDataRequest._();
  ContractStatDataRequest createEmptyInstance() => create();
  static $pb.PbList<ContractStatDataRequest> createRepeated() =>
      $pb.PbList<ContractStatDataRequest>();
  @$core.pragma('dart2js:noInline')
  static ContractStatDataRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContractStatDataRequest>(create);
...
class ContractStatDataResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ContractStatDataResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
  ...
  factory ContractStatDataResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContractStatDataResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ContractStatDataResponse clone() =>
      ContractStatDataResponse()..mergeFromMessage(this);
  ContractStatDataResponse copyWith(
          void Function(ContractStatDataResponse) updates) =>
      super.copyWith((message) => updates(message as ContractStatDataResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ContractStatDataResponse create() => ContractStatDataResponse._();
  ContractStatDataResponse createEmptyInstance() => create();
  static $pb.PbList<ContractStatDataResponse> createRepeated() =>
      $pb.PbList<ContractStatDataResponse>();
  @$core.pragma('dart2js:noInline')
  static ContractStatDataResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContractStatDataResponse>(create);
...
class ContractStatData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ContractStatData',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory ContractStatData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContractStatData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ContractStatData clone() => ContractStatData()..mergeFromMessage(this);
  ContractStatData copyWith(void Function(ContractStatData) updates) =>
      super.copyWith((message) => updates(message as ContractStatData));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ContractStatData create() => ContractStatData._();
  ContractStatData createEmptyInstance() => create();
  static $pb.PbList<ContractStatData> createRepeated() =>
      $pb.PbList<ContractStatData>();
  @$core.pragma('dart2js:noInline')
  static ContractStatData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContractStatData>(create);
  static ContractStatData _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get accountCount => $_getI64(0);
  @$pb.TagNumber(1)
  set accountCount($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set contractCount($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
...
class AddressContractsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AddressContractsRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..aOS(2, 'bcname')
    ..aOS(3, 'address')
  ...
  factory AddressContractsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AddressContractsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AddressContractsRequest clone() =>
      AddressContractsRequest()..mergeFromMessage(this);
  AddressContractsRequest copyWith(
          void Function(AddressContractsRequest) updates) =>
      super.copyWith((message) => updates(message as AddressContractsRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AddressContractsRequest create() => AddressContractsRequest._();
  AddressContractsRequest createEmptyInstance() => create();
  static $pb.PbList<AddressContractsRequest> createRepeated() =>
      $pb.PbList<AddressContractsRequest>();
  @$core.pragma('dart2js:noInline')
  static AddressContractsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AddressContractsRequest>(create);
...
class ContractList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ContractList',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..pc<ContractStatus>(1, 'contractStatus', $pb.PbFieldType.PM,
        subBuilder: ContractStatus.create)
    ..hasRequiredFields = false;

  ContractList._() : super();
  factory ContractList() => create();
  factory ContractList.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContractList.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ContractList clone() => ContractList()..mergeFromMessage(this);
  ContractList copyWith(void Function(ContractList) updates) =>
      super.copyWith((message) => updates(message as ContractList));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ContractList create() => ContractList._();
  ContractList createEmptyInstance() => create();
  static $pb.PbList<ContractList> createRepeated() =>
      $pb.PbList<ContractList>();
  @$core.pragma('dart2js:noInline')
  static ContractList getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContractList>(create);
...
class AddressContractsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AddressContractsResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<Header>(1, 'header', subBuilder: Header.create)
    ..m<$core.String, ContractList>(2, 'contracts',
        entryClassName: 'AddressContractsResponse.ContractsEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: ContractList.create,
        packageName: const $pb.PackageName('pb'))
    ..hasRequiredFields = false;

  AddressContractsResponse._() : super();
  factory AddressContractsResponse() => create();
  factory AddressContractsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AddressContractsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  AddressContractsResponse clone() =>
      AddressContractsResponse()..mergeFromMessage(this);
  AddressContractsResponse copyWith(
          void Function(AddressContractsResponse) updates) =>
      super.copyWith((message) => updates(message as AddressContractsResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AddressContractsResponse create() => AddressContractsResponse._();
  AddressContractsResponse createEmptyInstance() => create();
  static $pb.PbList<AddressContractsResponse> createRepeated() =>
      $pb.PbList<AddressContractsResponse>();
  @$core.pragma('dart2js:noInline')
  static AddressContractsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AddressContractsResponse>(create);
...
class CrossQueryRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CrossQueryRequest',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'bcname')
    ..aInt64(2, 'timestamp')
    ..aOS(3, 'initiator')
  ...
  factory CrossQueryRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CrossQueryRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  CrossQueryRequest clone() => CrossQueryRequest()..mergeFromMessage(this);
  CrossQueryRequest copyWith(void Function(CrossQueryRequest) updates) =>
      super.copyWith((message) => updates(message as CrossQueryRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CrossQueryRequest create() => CrossQueryRequest._();
  CrossQueryRequest createEmptyInstance() => create();
  static $pb.PbList<CrossQueryRequest> createRepeated() =>
      $pb.PbList<CrossQueryRequest>();
  @$core.pragma('dart2js:noInline')
  static CrossQueryRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CrossQueryRequest>(create);
...
class CrossQueryResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CrossQueryResponse',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
  ...
  factory CrossQueryResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CrossQueryResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  CrossQueryResponse clone() => CrossQueryResponse()..mergeFromMessage(this);
  CrossQueryResponse copyWith(void Function(CrossQueryResponse) updates) =>
      super.copyWith((message) => updates(message as CrossQueryResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CrossQueryResponse create() => CrossQueryResponse._();
  CrossQueryResponse createEmptyInstance() => create();
  static $pb.PbList<CrossQueryResponse> createRepeated() =>
      $pb.PbList<CrossQueryResponse>();
  @$core.pragma('dart2js:noInline')
  static CrossQueryResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CrossQueryResponse>(create);
  static CrossQueryResponse _defaultInstance;

  @$pb.TagNumber(1)
  ContractResponse get response => $_getN(0);
  @$pb.TagNumber(1)
  set response(ContractResponse v) {
    setField(1, v);
  }
...
class CrossChainMeta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CrossChainMeta',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'type')
  ...
  factory CrossChainMeta.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CrossChainMeta.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  CrossChainMeta clone() => CrossChainMeta()..mergeFromMessage(this);
  CrossChainMeta copyWith(void Function(CrossChainMeta) updates) =>
      super.copyWith((message) => updates(message as CrossChainMeta));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CrossChainMeta create() => CrossChainMeta._();
  CrossChainMeta createEmptyInstance() => create();
  static $pb.PbList<CrossChainMeta> createRepeated() =>
      $pb.PbList<CrossChainMeta>();
  @$core.pragma('dart2js:noInline')
  static CrossChainMeta getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CrossChainMeta>(create);
  ...
  @$pb.TagNumber(2)
  set minEndorsorNum($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
...
class CrossEndorsor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CrossEndorsor',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'address')
    ..aOS(2, 'pubKey')
    ..aOS(3, 'host')
  ...
  factory CrossEndorsor.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CrossEndorsor.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  CrossEndorsor clone() => CrossEndorsor()..mergeFromMessage(this);
  CrossEndorsor copyWith(void Function(CrossEndorsor) updates) =>
      super.copyWith((message) => updates(message as CrossEndorsor));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CrossEndorsor create() => CrossEndorsor._();
  CrossEndorsor createEmptyInstance() => create();
  static $pb.PbList<CrossEndorsor> createRepeated() =>
      $pb.PbList<CrossEndorsor>();
  @$core.pragma('dart2js:noInline')
  static CrossEndorsor getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CrossEndorsor>(create);
...
class CrossQueryMeta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CrossQueryMeta',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<CrossChainMeta>(1, 'chainMeta', subBuilder: CrossChainMeta.create)
    ..pc<CrossEndorsor>(2, 'endorsors', $pb.PbFieldType.PM,
        subBuilder: CrossEndorsor.create)
    ..hasRequiredFields = false;

  CrossQueryMeta._() : super();
  factory CrossQueryMeta() => create();
  factory CrossQueryMeta.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CrossQueryMeta.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  CrossQueryMeta clone() => CrossQueryMeta()..mergeFromMessage(this);
  CrossQueryMeta copyWith(void Function(CrossQueryMeta) updates) =>
      super.copyWith((message) => updates(message as CrossQueryMeta));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CrossQueryMeta create() => CrossQueryMeta._();
  CrossQueryMeta createEmptyInstance() => create();
  static $pb.PbList<CrossQueryMeta> createRepeated() =>
      $pb.PbList<CrossQueryMeta>();
  @$core.pragma('dart2js:noInline')
  static CrossQueryMeta getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CrossQueryMeta>(create);
  static CrossQueryMeta _defaultInstance;

  @$pb.TagNumber(1)
  CrossChainMeta get chainMeta => $_getN(0);
  @$pb.TagNumber(1)
  set chainMeta(CrossChainMeta v) {
    setField(1, v);
  }
...
class CrossQueryInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CrossQueryInfo',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOM<CrossQueryRequest>(1, 'request', subBuilder: CrossQueryRequest.create)
    ..aOM<CrossQueryResponse>(2, 'response',
        subBuilder: CrossQueryResponse.create)
    ..pc<SignatureInfo>(3, 'signs', $pb.PbFieldType.PM,
        subBuilder: SignatureInfo.create)
    ..hasRequiredFields = false;

  CrossQueryInfo._() : super();
  factory CrossQueryInfo() => create();
  factory CrossQueryInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CrossQueryInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  CrossQueryInfo clone() => CrossQueryInfo()..mergeFromMessage(this);
  CrossQueryInfo copyWith(void Function(CrossQueryInfo) updates) =>
      super.copyWith((message) => updates(message as CrossQueryInfo));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CrossQueryInfo create() => CrossQueryInfo._();
  CrossQueryInfo createEmptyInstance() => create();
  static $pb.PbList<CrossQueryInfo> createRepeated() =>
      $pb.PbList<CrossQueryInfo>();
  @$core.pragma('dart2js:noInline')
  static CrossQueryInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CrossQueryInfo>(create);
  static CrossQueryInfo _defaultInstance;

  @$pb.TagNumber(1)
  CrossQueryRequest get request => $_getN(0);
  @$pb.TagNumber(1)
  set request(CrossQueryRequest v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set response(CrossQueryResponse v) {
    setField(2, v);
  }
