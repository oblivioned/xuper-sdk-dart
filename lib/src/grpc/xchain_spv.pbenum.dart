...
class ReturnCode extends $pb.ProtobufEnum {
  ...
  static const ReturnCode HTTPREQUERTFAIL =
      ReturnCode._(101004, 'HTTPREQUERTFAIL');
  static const ReturnCode HTTPRESPONSEFAIL =
      ReturnCode._(101005, 'HTTPRESPONSEFAIL');
  static const ReturnCode ACCOUNTNOTEXIST =
      ReturnCode._(101008, 'ACCOUNTNOTEXIST');
  ...
  static const ReturnCode CONNECTNODEFAIL =
      ReturnCode._(102001, 'CONNECTNODEFAIL');
  static const ReturnCode UTXONOTENOUGH = ReturnCode._(102002, 'UTXONOTENOUGH');
  static const ReturnCode ADDRESSINVALID =
      ReturnCode._(102003, 'ADDRESSINVALID');
  static const ReturnCode FEEINVALID = ReturnCode._(102004, 'FEEINVALID');
  static const ReturnCode CONNECTREFUSED =
      ReturnCode._(102005, 'CONNECTREFUSED');
  static const ReturnCode UTXOENCRYPTERR =
      ReturnCode._(102006, 'UTXOENCRYPTERR');
  ...
  static const ReturnCode BLOCKCHAINNOTEXIST =
      ReturnCode._(102011, 'BLOCKCHAINNOTEXIST');
  ...
  static final $core.Map<$core.int, ReturnCode> _byValue =
