...
const XchainServiceBase$json = const {
  '1': 'Xchain',
  '2': const [
    const {'1': 'SelectUTXOBySize', '2': '.pb.UtxoInput', '3': '.pb.UtxoOutput', '4': const {}},
    const {'1': 'PostTx', '2': '.pb.TxStatus', '3': '.pb.CommonReply', '4': const {}},
    const {'1': 'QueryACL', '2': '.pb.AclStatus', '3': '.pb.AclStatus', '4': const {}},
    const {'1': 'QueryUtxoRecord', '2': '.pb.UtxoRecordDetail', '3': '.pb.UtxoRecordDetail', '4': const {}},
    const {'1': 'QueryContractStatData', '2': '.pb.ContractStatDataRequest', '3': '.pb.ContractStatDataResponse', '4': const {}},
    const {'1': 'GetAccountContracts', '2': '.pb.GetAccountContractsRequest', '3': '.pb.GetAccountContractsResponse', '4': const {}},
    const {'1': 'QueryTx', '2': '.pb.TxStatus', '3': '.pb.TxStatus', '4': const {}},
    const {'1': 'GetBalance', '2': '.pb.AddressStatus', '3': '.pb.AddressStatus', '4': const {}},
    const {'1': 'GetBalanceDetail', '2': '.pb.AddressBalanceStatus', '3': '.pb.AddressBalanceStatus', '4': const {}},
    const {'1': 'GetFrozenBalance', '2': '.pb.AddressStatus', '3': '.pb.AddressStatus', '4': const {}},
    const {'1': 'GetBlock', '2': '.pb.BlockID', '3': '.pb.Block', '4': const {}},
    const {'1': 'GetBlockByHeight', '2': '.pb.BlockHeight', '3': '.pb.Block', '4': const {}},
    const {'1': 'GetBlockChainStatus', '2': '.pb.BCStatus', '3': '.pb.BCStatus', '4': const {}},
    const {'1': 'GetBlockChains', '2': '.pb.CommonIn', '3': '.pb.BlockChains', '4': const {}},
    const {'1': 'GetSystemStatus', '2': '.pb.CommonIn', '3': '.pb.SystemsStatusReply', '4': const {}},
    const {'1': 'GetNetURL', '2': '.pb.CommonIn', '3': '.pb.RawUrl', '4': const {}},
    const {'1': 'SelectUTXO', '2': '.pb.UtxoInput', '3': '.pb.UtxoOutput', '4': const {}},
    const {'1': 'PreExecWithSelectUTXO', '2': '.pb.PreExecWithSelectUTXORequest', '3': '.pb.PreExecWithSelectUTXOResponse', '4': const {}},
    const {'1': 'DeployNativeCode', '2': '.pb.DeployNativeCodeRequest', '3': '.pb.DeployNativeCodeResponse'},
    const {'1': 'NativeCodeStatus', '2': '.pb.NativeCodeStatusRequest', '3': '.pb.NativeCodeStatusResponse'},
    const {'1': 'DposCandidates', '2': '.pb.DposCandidatesRequest', '3': '.pb.DposCandidatesResponse'},
    const {'1': 'DposNominateRecords', '2': '.pb.DposNominateRecordsRequest', '3': '.pb.DposNominateRecordsResponse'},
    const {'1': 'DposNomineeRecords', '2': '.pb.DposNomineeRecordsRequest', '3': '.pb.DposNomineeRecordsResponse'},
    const {'1': 'DposVoteRecords', '2': '.pb.DposVoteRecordsRequest', '3': '.pb.DposVoteRecordsResponse'},
    const {'1': 'DposVotedRecords', '2': '.pb.DposVotedRecordsRequest', '3': '.pb.DposVotedRecordsResponse'},
    const {'1': 'DposCheckResults', '2': '.pb.DposCheckResultsRequest', '3': '.pb.DposCheckResultsResponse'},
    const {'1': 'DposStatus', '2': '.pb.DposStatusRequest', '3': '.pb.DposStatusResponse'},
    const {'1': 'GetAccountByAK', '2': '.pb.AK2AccountRequest', '3': '.pb.AK2AccountResponse', '4': const {}},
    const {'1': 'GetAddressContracts', '2': '.pb.AddressContractsRequest', '3': '.pb.AddressContractsResponse', '4': const {}},
    const {'1': 'PreExec', '2': '.pb.InvokeRPCRequest', '3': '.pb.InvokeRPCResponse', '4': const {}},
  ],
};

const XchainServiceBase$messageJson = const {
  '.pb.UtxoInput': UtxoInput$json,
  '.pb.Header': Header$json,
  '.pb.UtxoOutput': UtxoOutput$json,
  '.pb.Utxo': Utxo$json,
  '.pb.TxStatus': TxStatus$json,
  '.pb.Transaction': Transaction$json,
  '.pb.TxInput': TxInput$json,
  '.pb.TxOutput': TxOutput$json,
  '.pb.TxInputExt': TxInputExt$json,
  '.pb.TxOutputExt': TxOutputExt$json,
  '.pb.InvokeRequest': InvokeRequest$json,
  '.pb.InvokeRequest.ArgsEntry': InvokeRequest_ArgsEntry$json,
  '.pb.ResourceLimit': ResourceLimit$json,
  '.pb.SignatureInfo': SignatureInfo$json,
  '.pb.XuperSignature': XuperSignature$json,
  '.pb.ModifyBlock': ModifyBlock$json,
  '.pb.HDInfo': HDInfo$json,
  '.pb.CommonReply': CommonReply$json,
  '.pb.AclStatus': AclStatus$json,
  '.pb.Acl': Acl$json,
  '.pb.PermissionModel': PermissionModel$json,
  '.pb.Acl.AksWeightEntry': Acl_AksWeightEntry$json,
  '.pb.AkSets': AkSets$json,
  '.pb.AkSets.SetsEntry': AkSets_SetsEntry$json,
  '.pb.AkSet': AkSet$json,
  '.pb.UtxoRecordDetail': UtxoRecordDetail$json,
  '.pb.UtxoRecord': UtxoRecord$json,
  '.pb.UtxoKey': UtxoKey$json,
  '.pb.ContractStatDataRequest': ContractStatDataRequest$json,
  '.pb.ContractStatDataResponse': ContractStatDataResponse$json,
  '.pb.ContractStatData': ContractStatData$json,
  '.pb.GetAccountContractsRequest': GetAccountContractsRequest$json,
  '.pb.GetAccountContractsResponse': GetAccountContractsResponse$json,
  '.pb.ContractStatus': ContractStatus$json,
  '.pb.AddressStatus': AddressStatus$json,
  '.pb.TokenDetail': TokenDetail$json,
  '.pb.AddressBalanceStatus': AddressBalanceStatus$json,
  '.pb.TokenFrozenDetails': TokenFrozenDetails$json,
  '.pb.TokenFrozenDetail': TokenFrozenDetail$json,
  '.pb.BlockID': BlockID$json,
  '.pb.Block': Block$json,
  '.pb.InternalBlock': InternalBlock$json,
  '.pb.InternalBlock.FailedTxsEntry': InternalBlock_FailedTxsEntry$json,
  '.pb.QuorumCert': $0.QuorumCert$json,
  '.pb.QCSignInfos': $0.QCSignInfos$json,
  '.pb.SignInfo': $0.SignInfo$json,
  '.pb.BlockHeight': BlockHeight$json,
  '.pb.BCStatus': BCStatus$json,
  '.pb.LedgerMeta': LedgerMeta$json,
  '.pb.UtxoMeta': UtxoMeta$json,
  '.pb.GasPrice': GasPrice$json,
  '.pb.CommonIn': CommonIn$json,
  '.pb.BlockChains': BlockChains$json,
  '.pb.SystemsStatusReply': SystemsStatusReply$json,
  '.pb.SystemsStatus': SystemsStatus$json,
  '.pb.Speeds': Speeds$json,
  '.pb.Speeds.SumSpeedsEntry': Speeds_SumSpeedsEntry$json,
  '.pb.Speeds.BcSpeedsEntry': Speeds_BcSpeedsEntry$json,
  '.pb.BCSpeeds': BCSpeeds$json,
  '.pb.BCSpeeds.BcSpeedEntry': BCSpeeds_BcSpeedEntry$json,
  '.pb.RawUrl': RawUrl$json,
  '.pb.PreExecWithSelectUTXORequest': PreExecWithSelectUTXORequest$json,
  '.pb.InvokeRPCRequest': InvokeRPCRequest$json,
  '.pb.PreExecWithSelectUTXOResponse': PreExecWithSelectUTXOResponse$json,
  '.pb.InvokeResponse': InvokeResponse$json,
  '.pb.ContractResponse': ContractResponse$json,
  '.pb.DeployNativeCodeRequest': DeployNativeCodeRequest$json,
  '.pb.NativeCodeDesc': NativeCodeDesc$json,
  '.pb.DeployNativeCodeResponse': DeployNativeCodeResponse$json,
  '.pb.NativeCodeStatusRequest': NativeCodeStatusRequest$json,
  '.pb.NativeCodeStatusResponse': NativeCodeStatusResponse$json,
  '.pb.NativeCodeStatus': NativeCodeStatus$json,
  '.pb.DposCandidatesRequest': DposCandidatesRequest$json,
  '.pb.DposCandidatesResponse': DposCandidatesResponse$json,
  '.pb.DposNominateRecordsRequest': DposNominateRecordsRequest$json,
  '.pb.DposNominateRecordsResponse': DposNominateRecordsResponse$json,
  '.pb.DposNominateInfo': DposNominateInfo$json,
  '.pb.DposNomineeRecordsRequest': DposNomineeRecordsRequest$json,
  '.pb.DposNomineeRecordsResponse': DposNomineeRecordsResponse$json,
  '.pb.DposVoteRecordsRequest': DposVoteRecordsRequest$json,
  '.pb.DposVoteRecordsResponse': DposVoteRecordsResponse$json,
  '.pb.voteRecord': voteRecord$json,
  '.pb.DposVotedRecordsRequest': DposVotedRecordsRequest$json,
  '.pb.DposVotedRecordsResponse': DposVotedRecordsResponse$json,
  '.pb.votedRecord': votedRecord$json,
  '.pb.DposCheckResultsRequest': DposCheckResultsRequest$json,
  '.pb.DposCheckResultsResponse': DposCheckResultsResponse$json,
  '.pb.DposStatusRequest': DposStatusRequest$json,
  '.pb.DposStatusResponse': DposStatusResponse$json,
  '.pb.DposStatus': DposStatus$json,
  '.pb.AK2AccountRequest': AK2AccountRequest$json,
  '.pb.AK2AccountResponse': AK2AccountResponse$json,
  '.pb.AddressContractsRequest': AddressContractsRequest$json,
  '.pb.AddressContractsResponse': AddressContractsResponse$json,
  '.pb.AddressContractsResponse.ContractsEntry': AddressContractsResponse_ContractsEntry$json,
