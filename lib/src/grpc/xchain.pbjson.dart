...
const Transaction$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'received_timestamp',
      '3': 30,
      '4': 1,
      '5': 3,
      '10': 'receivedTimestamp'
    },
    const {
      '1': 'xuper_sign',
      '3': 31,
...
const UtxoMeta$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 11,
      '6': '.pb.InvokeRequest',
      '10': 'reservedContracts'
    },
    const {
      '1': 'forbidden_contract',
      '3': 8,
      '4': 1,
      '5': 11,
      '6': '.pb.InvokeRequest',
      '10': 'forbiddenContract'
    },
    const {
      '1': 'new_account_resource_amount',
      '3': 9,
      '4': 1,
      '5': 3,
      '10': 'newAccountResourceAmount'
    },
    const {
      '1': 'irreversibleBlockHeight',
      '3': 10,
      '4': 1,
      '5': 3,
      '10': 'irreversibleBlockHeight'
    },
    const {
      '1': 'irreversibleSlideWindow',
      '3': 11,
      '4': 1,
      '5': 3,
      '10': 'irreversibleSlideWindow'
    },
    const {
      '1': 'gasPrice',
      '3': 12,
    ...
    const {
      '1': 'group_chain_contract',
      '3': 13,
      '4': 1,
      '5': 11,
      '6': '.pb.InvokeRequest',
      '10': 'groupChainContract'
    },
  ],
};
...
const InternalBlock$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.pb.InternalBlock.FailedTxsEntry',
      '10': 'failedTxs'
    },
...
const AddressContractsResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.pb.AddressContractsResponse.ContractsEntry',
      '10': 'contracts'
    },
  ],
