...
class ECDSAAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ECDSAAccount',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'entropyByte', $pb.PbFieldType.OY,
        protoName: 'entropyByte')
    ..aOS(2, 'mnemonic')
  ...
  factory ECDSAAccount.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ECDSAAccount.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ECDSAAccount clone() => ECDSAAccount()..mergeFromMessage(this);
  ECDSAAccount copyWith(void Function(ECDSAAccount) updates) =>
      super.copyWith((message) => updates(message as ECDSAAccount));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ECDSAAccount create() => ECDSAAccount._();
  ECDSAAccount createEmptyInstance() => create();
  static $pb.PbList<ECDSAAccount> createRepeated() =>
      $pb.PbList<ECDSAAccount>();
  @$core.pragma('dart2js:noInline')
  static ECDSAAccount getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ECDSAAccount>(create);
  static ECDSAAccount _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get entropyByte => $_getN(0);
  @$pb.TagNumber(1)
  set entropyByte($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
  ...
  @$pb.TagNumber(3)
  set jsonPrivateKey($core.String v) {
    $_setString(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set jsonPublicKey($core.String v) {
    $_setString(3, v);
  }
...
class ECDSAInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ECDSAInfo',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'entropyByte', $pb.PbFieldType.OY,
        protoName: 'entropyByte')
    ..aOS(2, 'mnemonic')
  ...
  factory ECDSAInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ECDSAInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ECDSAInfo clone() => ECDSAInfo()..mergeFromMessage(this);
  ECDSAInfo copyWith(void Function(ECDSAInfo) updates) =>
      super.copyWith((message) => updates(message as ECDSAInfo));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ECDSAInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ECDSAInfo>(create);
...
class ECDSAAccountFromCloud extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ECDSAAccountFromCloud',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'address')
  ...
  factory ECDSAAccountFromCloud.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ECDSAAccountFromCloud.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ECDSAAccountFromCloud clone() =>
      ECDSAAccountFromCloud()..mergeFromMessage(this);
  ECDSAAccountFromCloud copyWith(
          void Function(ECDSAAccountFromCloud) updates) =>
      super.copyWith((message) => updates(message as ECDSAAccountFromCloud));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ECDSAAccountFromCloud create() => ECDSAAccountFromCloud._();
  ECDSAAccountFromCloud createEmptyInstance() => create();
  static $pb.PbList<ECDSAAccountFromCloud> createRepeated() =>
      $pb.PbList<ECDSAAccountFromCloud>();
  @$core.pragma('dart2js:noInline')
  static ECDSAAccountFromCloud getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ECDSAAccountFromCloud>(create);
  ...
  @$pb.TagNumber(2)
  set jsonEncryptedPrivateKey($core.String v) {
    $_setString(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set encryptedMnemonic($core.String v) {
    $_setString(2, v);
  }
...
class ECDSAAccountToCloud extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ECDSAAccountToCloud',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..aOS(1, 'address')
    ..aOS(2, 'jsonEncryptedPrivateKey', protoName: 'jsonEncryptedPrivateKey')
    ..aOS(3, 'encryptedMnemonic', protoName: 'encryptedMnemonic')
  ...
  factory ECDSAAccountToCloud.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ECDSAAccountToCloud.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ECDSAAccountToCloud clone() => ECDSAAccountToCloud()..mergeFromMessage(this);
  ECDSAAccountToCloud copyWith(void Function(ECDSAAccountToCloud) updates) =>
      super.copyWith((message) => updates(message as ECDSAAccountToCloud));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ECDSAAccountToCloud create() => ECDSAAccountToCloud._();
  ECDSAAccountToCloud createEmptyInstance() => create();
  static $pb.PbList<ECDSAAccountToCloud> createRepeated() =>
      $pb.PbList<ECDSAAccountToCloud>();
  @$core.pragma('dart2js:noInline')
  static ECDSAAccountToCloud getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ECDSAAccountToCloud>(create);
...
class Node extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Node',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'host', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, 'utxoQueryUrl', $pb.PbFieldType.OY,
        protoName: 'utxoQueryUrl')
    ..a<$core.List<$core.int>>(3, 'txPostUrl', $pb.PbFieldType.OY,
        protoName: 'txPostUrl')
    ..a<$core.List<$core.int>>(4, 'balanceQueryUrl', $pb.PbFieldType.OY,
        protoName: 'balanceQueryUrl')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set utxoQueryUrl($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set txPostUrl($core.List<$core.int> v) {
    $_setBytes(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set balanceQueryUrl($core.List<$core.int> v) {
    $_setBytes(3, v);
  }
...
class TxInputs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TxInputs',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..pc<$0.TxInput>(1, 'txInputList', $pb.PbFieldType.PM,
        protoName: 'txInputList', subBuilder: $0.TxInput.create)
    ..hasRequiredFields = false;

  TxInputs._() : super();
  factory TxInputs() => create();
  factory TxInputs.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TxInputs.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TxInputs clone() => TxInputs()..mergeFromMessage(this);
  TxInputs copyWith(void Function(TxInputs) updates) =>
      super.copyWith((message) => updates(message as TxInputs));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static TxInputs getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TxInputs>(create);
...
class TxOutputs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TxOutputs',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..pc<$0.TxOutput>(1, 'txOutputList', $pb.PbFieldType.PM,
        protoName: 'txOutputList', subBuilder: $0.TxOutput.create)
    ..hasRequiredFields = false;
...
class UTXOs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UTXOs',
      package: const $pb.PackageName('pb'), createEmptyInstance: create)
    ..pc<UTXO>(1, 'uTXOList', $pb.PbFieldType.PM,
        protoName: 'uTXOList', subBuilder: UTXO.create)
    ..hasRequiredFields = false;

  UTXOs._() : super();
  factory UTXOs() => create();
  factory UTXOs.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UTXOs.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  UTXOs clone() => UTXOs()..mergeFromMessage(this);
  UTXOs copyWith(void Function(UTXOs) updates) =>
      super.copyWith((message) => updates(message as UTXOs));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
